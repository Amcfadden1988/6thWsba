...
const API_KEY =
  "live_AJYuhjIw2saL0bc0z8KTLWHKi9J4jIgRJD0eZf57AGruDa7fqEsL34WVOzKhsXIt";
...
async function handleBreedSelect() {
  ...
  const res = await fetch (`https://api.thedogapi.com/v1/images/search?limit=10&breed_ids=${breedSelect.value}`,
    ...
    axios.get("https://api.thedogapi.com/v1/favourites").then((res) => {
      ...
      res.data.forEach((item) => {
        ...
        if (item.image_id === imgId) {
          ...
          // delete
          deleted = true;
          axios.delete(`https://api.thedogapi.com/v1/favourites/${item.id}`)
      ...
      if (!deleted) {
        // add
        axios
          .post("https://api.thedogapi.com/v1/favourites", { image_id: imgId, sub_id: 'abe' })
...
function getFavourites() {
    axios.get("https://api.thedogapi.com/v1/favourites")
    .then(res => {
